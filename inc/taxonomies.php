		...
		<div class="cptui-section">
			...
			<table class="form-table cptui-table">
				<?php
					...
					echo $ui->get_text_input( array(
						...
						'aftertext' => esc_attr__( '(e.g. Actor)', 'custom-post-type-ui' ),
			...
			<p class="submit">
				...
				if ( ! empty( $_GET ) && ! empty( $_GET['action'] ) && 'edit' == $_GET['action'] ) { ?>
					 ...
					 */
					?>
					<input type="submit" class="button-secondary" name="cpt_delete" id="cpt_submit_delete" value="<?php echo apply_filters( 'cptui_taxonomy_submit_delete', esc_attr__( 'Delete Taxonomy', 'custom-post-type-ui' ) ); ?>" />
				<?php } else { ?>
					<?php
			...
			<table class="form-table cptui-table">
				...
				if ( isset( $current['description'] ) ) {
					...
					echo $ui->get_textarea_input( array(
						...
						'helptext'  => esc_html__( 'Describe what your taxonomy is used for.', 'custom-post-type-ui' ),
					) );
					...
					echo $ui->get_text_input( array(
						...
						'aftertext' => esc_attr__( '(e.g. No actors)', 'custom-post-type-ui' ),
						'labeltext' => esc_html__( 'No terms', 'custom-post-type-ui' ),
						'helptext'  => esc_html__( 'Used when indicating that there are no terms in the given taxonomy associated with an object.', 'custom-post-type-ui' ),
					) );
					...
					echo $ui->get_text_input( array(
						...
						'aftertext' => esc_attr__( '(e.g. Actors list navigation)', 'custom-post-type-ui' ),
						'labeltext' => esc_html__( 'Items List Navigation', 'custom-post-type-ui' ),
						'helptext'  => esc_html__( 'Screen reader text for the pagination heading on the term listing screen.', 'custom-post-type-ui' ),
					) );
					...
					echo $ui->get_text_input( array(
						...
						'aftertext' => esc_attr__( '(e.g. Actors list)', 'custom-post-type-ui' ),
						'labeltext' => esc_html__( 'Items List', 'custom-post-type-ui' ),
						'helptext'  => esc_html__( 'Screen reader text for the items list heading on the term listing screen.', 'custom-post-type-ui' ),
					) );
				?>
			</table>
			...
			<table class="form-table cptui-table">
				<?php
					...
					echo $ui->get_text_input( array(
						...
						'helptext'  => esc_html__( 'Slug to use in REST API URLs.', 'custom-post-type-ui' ),
						'namearray' => 'cpt_custom_tax',
						'name'      => 'rest_base',
